import numpy as np
from modern_robotics import MatrixExp6, VecTose3, Adjoint, TransInv
...
def prb_body_jacobian(q, pr):
    """
    Compute the body Jacobian for the pseudo-rigid-body model.
    ...
    Returns:
    - Jb: numpy array, shape (6, 3*(N-1)), body Jacobian matrix
    """
